            ...
            <div class="box-body">
                ...
                <div class="white-form">
					...
					<label for="AgeOfCar"><?php echo pll__('date_year');?>
                       ...
                       <input type="number" min="1980" max="2019" step="1" maxlength="7" name="date_year" id="date_year" value="">
                ...
                <div class="result result-customs" id="result">
                    ...
                    <div class="res-in">
                        ...
                        <div>
                            ...
                            <p><?php echo pll__('Оформление');?></p>

                            <p id="execution" class="orange value"></p>
